...
DOMAIN_NAF_CODES = {
    ...
    "DERATISATION": ["8129A"],
    "DEMENAGEMENT": ["4942Z"],
    "DEPANNAGE_AUTO": ["5221Z", "4520A"],
    "ELECTROMENAGER": ["9522Z"],
    "DIAGNOSTIC_IMMO": ["7120B"],
    ...
    "AUTO": ["4511Z", "4519Z", "4520A", "4520B", "4531Z", "4532Z", "4540Z", "5221Z", "7120A", "8553Z"],
    "SANTE": ["7500Z", "8610Z", "8621Z", "8622A", "8622B", "8622C", "8623Z", "8690A", "8690B", "8690C", "8690D", "8690E", "8690F"],
    "SERVICES": ["4942Z", "6910Z", "6920Z", "7010Z", "7021Z", "7022Z", "7111Z", "7112A", "7112B", "7120A", "7120B", "7311Z", "7312Z", "8129A", "9522Z", "9603Z", "6831Z"],
    "B2B": [
        "6831Z", "6910Z", "6920Z",
        "7010Z", "7021Z", "7022Z",
