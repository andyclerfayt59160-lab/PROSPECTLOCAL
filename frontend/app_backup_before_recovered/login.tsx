      ...
      <View style={styles.container}>
        <View style={styles.successContainer}>
          ...
          <Text style={styles.successSubMessage}>
            Un administrateur validera votre accès prochainement. Vous recevrez une confirmation dès que votre compte sera activé.
          </Text>
    ...
    >
      <View style={styles.content}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Prospect Local</Text>
          <Text style={styles.subtitle}>
            Détecteur d'opportunités locales
          </Text>
        </View>
